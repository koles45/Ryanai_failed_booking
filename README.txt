## To run this test you need to have Ruby 2.3.1 (or latest) installed

### WINDOWS ###
## Download and run installer from => https://rubyinstaller.org/
#
...
# open command line in folder where you downloaded files and type in: ruby booking_sad_path.rb
